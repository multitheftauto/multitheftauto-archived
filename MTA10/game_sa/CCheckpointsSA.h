...
public:	
	...
	CCheckpoint*		CreateCheckpoint( DWORD Identifier, short wType, const CVector& vecPosition, const CVector& vecPointDir, float fSize, float fPulseFraction, RGBA Color );
