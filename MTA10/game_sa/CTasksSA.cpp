...
CTaskSimpleIKChain* CTasksSA::CreateTaskSimpleIKChain( char* idString, int effectorBoneTag, const CVector& effectorVec, int pivotBoneTag, CEntity* pEntity, int offsetBoneTag, const CVector& offsetPos, float speed, int time, int blendTime )
{
...
CTaskSimpleIKLookAt* CTasksSA::CreateTaskSimpleIKLookAt( char* idString, CEntity* pEntity, int time, int offsetBoneTag, const CVector& offsetPos, unsigned char useTorso, float speed, int blendTime, int m_priority )
{
...
CTaskSimpleTriggerLookAt* CTasksSA::CreateTaskSimpleTriggerLookAt( CEntity* pEntity, int time, int offsetBoneTag, const CVector& offsetPos, unsigned char useTorso, float speed, int blendTime, int priority )
{
...
CTaskSimpleGangDriveBy* CTasksSA::CreateTaskSimpleGangDriveBy( CEntity* pTargetEntity, const CVector& vecTarget, float fAbortRange, char FrequencyPercentage, char nDrivebyStyle, bool bSeatRHS )
{
    CTaskSimpleGangDriveBySA* pTask = new CTaskSimpleGangDriveBySA ( pTargetEntity, vecTarget, fAbortRange, FrequencyPercentage, nDrivebyStyle, bSeatRHS );
    m_pTaskManagementSystem->AddTask ( pTask );
    return pTask;
}

CTaskSimpleUseGun* CTasksSA::CreateTaskSimpleUseGun( CEntity* pTargetEntity, const CVector& vecTarget, char nCommand, short nBurstLength, unsigned char bAimImmediate )
{
