...
public:
	...
	virtual CPedIntelligence*	GetPedIntelligence( void ) = 0;
    ...
    virtual const CVector		GetBonePosition( eBone bone ) = 0;
    virtual const CVector		GetTransformedBonePosition( eBone bone ) = 0;
