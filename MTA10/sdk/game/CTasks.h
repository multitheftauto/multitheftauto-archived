...
public:
    ...
    // IK
    virtual CTaskSimpleIKChain                  * CreateTaskSimpleIKChain( char* idString, int effectorBoneTag, const CVector& effectorVec, int pivotBoneTag, CEntity* pEntity, int offsetBoneTag, const CVector& offsetPos, float speed, int time=99999999, int blendTime=1000 )=0;
    virtual CTaskSimpleIKLookAt                 * CreateTaskSimpleIKLookAt( char* idString, CEntity* pEntity, int time, int offsetBoneTag, const CVector& offsetPos, unsigned char useTorso=false, float speed=0.25f, int blendTime=1000, int m_priority=3 )=0;
    virtual CTaskSimpleTriggerLookAt            * CreateTaskSimpleTriggerLookAt( CEntity* pEntity, int time, int offsetBoneTag, const CVector& offsetPos, unsigned char useTorso=false, float speed=0.25f, int blendTime=1000, int priority=3 )=0;
    ...
    virtual CTaskSimpleUseGun                   * CreateTaskSimpleUseGun( CEntity *pTargetEntity, const CVector& vecTarget, char nCommand, short nBurstLength=1, unsigned char bAimImmediate=false )=0;
