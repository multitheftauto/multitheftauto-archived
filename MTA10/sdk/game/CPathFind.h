...
{
public:
	virtual CNodeAddress*	FindNthNodeClosestToCoors( const CVector& vecCoors, int iNodeNumber, int iType, CNodeAddress * pNodeAddress, float fDistance ) = 0;
	virtual CPathNode*		GetPathNode( CNodeAddress * node ) = 0;
	virtual const CVector	GetNodePosition( CPathNode * pNode ) = 0;
	virtual const CVector	GetNodePosition( CNodeAddress * pNode ) = 0;
    virtual void            SwitchRoadsOffInArea( const CVector& vecAreaCorner1, const CVector& vecAreaCorner2, bool bEnable = false ) = 0;
    virtual void            SwitchPedRoadsOffInArea( const CVector& vecAreaCorner1, const CVector& vecAreaCorner2, bool bEnable = false ) = 0;
