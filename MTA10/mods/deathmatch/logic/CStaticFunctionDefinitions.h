...
public:
    ...
    static bool                         GetElementMatrix                    ( CClientEntity& Entity, CMatrix4& matrix );
    ...
    static bool                         SetElementInterior                  ( CClientEntity& Entity, unsigned char ucInterior, bool bSetPosition, const CVector& vecPosition );
    static bool                         SetElementDimension                 ( CClientEntity& Entity, unsigned short usDimension );
    static bool                         AttachElements                      ( CClientEntity& Entity, CClientEntity& AttachedToEntity, const CVector& vecPosition, const CVector& vecRotation );
    static bool                         DetachElements                      ( CClientEntity& Entity, CClientEntity* pAttachedToEntity = NULL );
    static bool                         SetElementAttachedOffsets           ( CClientEntity& Entity, const CVector& vecPosition, const CVector& vecRotation );
    ...
    static bool                         SetPedLookAt                        ( CClientEntity& Entity, const CVector& vecPosition, int iTime, CClientEntity* pTarget );
